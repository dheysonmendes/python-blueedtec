...
#    decisao = str(input('Deseja continuar? SIM/NAO: ').upper())
#    if decisao != 'SIM':
#       print('Fim do programa.')
#       break
# print(f'Foi cadastrada {len(nomes)} pessoa(s).')
# print(f'O maior peso foi {max(pesos)} kg.')
# print(f'O menorr peso foi {min(pesos)} kg.')
...
# print(f'O menor peso é {pesoMaior} kg.')
...
#    decisao = input('Desja continuar? S/N ').upper()
